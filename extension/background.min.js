...
function main() {
	...
	$.when(
		...
		window.addEventListener('online', function(e) {
			...
			pollUserInfo();
			//added this so if a chromebook switches wireless networks before next submission it will catch it and submit. The script doesn't
			//always see the change in network due to the br0 interface being 100.x.x.x.  This forces it to call home.
			sendUserInfo();
			chrome.alarms.create('poll', {delayInMinutes: pollInterval, periodInMinutes: pollInterval} );
		});
	});
